...
const pageMeta = {
  ...
  description: "Camzify AI attribute extraction uses a vision-language model to attach structured attributes — clothing, object type, behaviour — to every detection.",
...
const faqs = [
  { question: 'What is AI attribute extraction?', answer: 'AI attribute extraction uses a vision-language model to read the scene the moment an alert fires and attach structured, human-readable attributes to it — clothing colour, object type, general behaviour — with no operator input required.' },
  ...
  { question: 'What kinds of attributes does it capture?', answer: 'Typical attributes include clothing colour and type, carried objects, general behaviour description, and object classification — the same kind of detail a human reviewer would note when describing what they saw on camera.' },
  { question: 'Does this replace facial recognition?', answer: 'No. Attribute extraction describes general visual characteristics like clothing and behaviour rather than identifying a specific individual\'s identity, which keeps it useful for investigation and search without functioning as a biometric identification system.' },
    ...
    <PageShell {...pageMeta} faqs={faqs} breadcrumbs={[
      ...
      <section className="pb-16">
        <div className="mx-auto max-w-site px-6">
            ...
            <ScrollReveal>
              <div>
                ...
                <ul className="mt-4 space-y-3 text-muted-foreground">
                  <li className="flex gap-2">• Structured clothing colour and type attributes for every detected subject</li>
                  <li className="flex gap-2">• Object classification for vehicles, bags, and other carried items</li>
                  <li className="flex gap-2">• Plain-language behaviour descriptions attached to each alert</li>
          ...
          <div className="mt-16">
            <ScrollReveal>
              ...
              <div className="mt-4 space-y-4 max-w-prose text-muted-foreground">
                ...
                <p>That manual description step is slow and inconsistent — two reviewers describing the same clip might use different words for the same clothing colour or miss a detail the other caught. Multiplied across dozens of alerts a day, it adds real delay between something happening and someone being able to act on it.</p>
          ...
          <div className="mt-16 grid items-center gap-12 lg:grid-cols-2">
            ...
            <ScrollReveal>
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  Those details are converted into structured fields — clothing colour, object type, behaviour description — rather than free-form text, so they can be filtered, searched, and compared consistently across thousands of alerts.
                </p>
            ...
            <ScrollReveal>
              <div>
                ...
                <ul className="mt-4 space-y-3 text-muted-foreground">
                  ...
                  <li className="flex gap-2">• Attribute categories captured — clothing, objects, behaviour</li>
          ...
          <div className="mt-16 grid items-center gap-12 lg:grid-cols-2">
            <PlaceholderVisual type="industry" caption="RICHER ALERT CONTEXT" alt="Notification queue showing alerts enriched with structured clothing and behaviour attributes" />
            <ScrollReveal>
              <div>
                ...
                <ul className="mt-4 space-y-3 text-muted-foreground">
                  ...
                  <li className="flex gap-2">• A vehicle-related alert includes the vehicle's colour and general type</li>
