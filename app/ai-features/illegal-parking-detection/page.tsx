      ...
      <section className="pb-16">
        <div className="mx-auto max-w-site px-6">
          ...
          <div className="mt-16 grid items-center gap-12 lg:grid-cols-2">
            <PhotoFigure src="/feature-illegal-parking-detection-2.webp" alt="Diagram showing a vehicle track entering a restricted zone and a dwell timer counting toward the grace period threshold" caption="Dwell timer logic" />
            <ScrollReveal>
              <div>
