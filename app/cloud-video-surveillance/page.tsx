...
const faqs = [
  ...
  { question: 'What does it cost?', answer: 'Camzify is priced per instance per month, a stream instance for each camera plus a detection instance for each AI feature on it and cloud storage, and quoted for the site. The pricing page shows approximate list rates and an estimator for your own counts, with quotes below list for an annual term, and the ROI calculator lets you compare it against the guarding or recorder costs it replaces.' },
];
