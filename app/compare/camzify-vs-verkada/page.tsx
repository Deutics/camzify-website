        ...
        <div className="mx-auto max-w-site px-6">
          ...
          <div className="mt-16">
            <ScrollReveal>
              ...
              <p className="mt-4 max-w-prose text-muted-foreground">
                If you are replacing your cameras and want doors and alarms on the same platform, Verkada is built for exactly that. If your cameras work and the gap is that nobody can prove the rounds were done, Camzify puts detections and scheduled patrol rounds on those cameras without a hardware purchase. The two answer different questions about the same building.
              </p>
              <p className="mt-4 max-w-prose text-muted-foreground">
