...
const faqs = [
  ...
  { question: 'How is it priced for us?', answer: 'Per camera, quoted for the portfolio you would cover. Camzify starts from $5 per camera per month; a partner portfolio is quoted as a whole. The ROI calculator has an agency mode that takes your client count and the price you would charge and shows the recurring revenue; the quote comes back against that.' },
];
