...
const faqs = [
  ...
  { question: 'How is it priced for us?', answer: 'Per camera, quoted for the portfolio you would cover. Approximate list rates and an estimator are on the pricing page; a partner portfolio is quoted below them. The ROI calculator has an agency mode that takes your client count and the price you would charge and shows the recurring revenue; the quote comes back against that.' },
];
