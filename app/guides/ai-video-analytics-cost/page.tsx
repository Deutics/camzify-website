...
const faqs = [
  { question: 'How is AI video analytics usually priced?', answer: 'Most vendors price per camera per month, per detection or per bundle, sometimes with a platform fee. Camzify licenses AI features per camera instance on top of an account that includes the platform modules. It starts from $5 per camera per month, and most cameras land between $20 and $90 per camera per month depending on which detections run and whether patrol rounds are on; the exact rate is quoted per site.' },
