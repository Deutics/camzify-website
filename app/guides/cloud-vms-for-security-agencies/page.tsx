...
const faqs = [
  ...
  { question: 'How is Camzify priced for an agency?', answer: 'Per camera, quoted for the portfolio you would cover. Approximate list rates are on the pricing page and a partner portfolio is quoted below them; there is no published partner margin, tier or portal, and terms are agreed in conversation. You set your own price per client site per month against the quote, and the ROI calculator has an agency mode for that arithmetic.' },
