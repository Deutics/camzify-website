...
export default function Page() {
  return (
    <PageShell
      {...pageMeta}
      faqs={faqs}
      schema={[howToSchema({ name: 'How to configure cloud video backup in Camzify', description: pageMeta.description, path: pageMeta.path, steps }), articleSchema({ headline: pageMeta.title, description: pageMeta.description, path: pageMeta.path, datePublished: publishedTime, dateModified: modifiedTime }), personSchema()]}
      ...
      <section className="pb-16">
        <div className="mx-auto max-w-site px-6">
          ...
          <div className="mt-10 max-w-3xl">
            <PhotoFigure src="/guide-how-to-configure-cloud-video-backup.webp" alt="Illustration for this guide: the Camzify console and the cameras it runs on" priority />
          </div>
