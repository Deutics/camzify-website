...
export default function Page() {
  return (
    <PageShell
      {...pageMeta}
      faqs={faqs}
      schema={[howToSchema({ name: 'How to manage security camera alerts in Camzify', description: pageMeta.description, path: pageMeta.path, steps }), articleSchema({ headline: pageMeta.title, description: pageMeta.description, path: pageMeta.path, datePublished: publishedTime, dateModified: modifiedTime }), personSchema()]}
