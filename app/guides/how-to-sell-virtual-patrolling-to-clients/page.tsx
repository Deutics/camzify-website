...
const faqs = [
  ...
  { question: 'What do I say when they ask what it costs?', answer: 'Your price per site per month, set against the quote you have from us. The pricing page shows approximate list rates, and your quote as a partner comes in below them for a portfolio, so the proposal should carry your price rather than repeat ours.' },
