...
const faqs = [
  ...
  { question: 'What do I say when they ask what it costs?', answer: 'Your price per site per month, set against the quote you have from us. Camzify is quoted per portfolio for a partner, so the proposal should carry your price rather than repeat ours.' },
