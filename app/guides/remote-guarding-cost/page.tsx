...
const faqs = [
  ...
  { question: "What does remote video monitoring cost?", answer: "Remote video monitoring is the same service under a different name, and it is priced the same way: per camera per month, set by the hours covered, the response included and whether cameras are bundled. Use the drivers on this page to compare quotes, and remember that a scheduled camera round from Camzify sits underneath a monitoring service rather than replacing the people in it. For the software layer itself, Camzify starts from $5 per camera per month and most cameras land between $20 and $90 per camera per month with detections and patrol rounds; the human monitoring on top is priced by whoever provides it." },
];
