...
const faqs = [
  { question: 'Does Camzify publish prices?', answer: "No. Pricing is per instance per month and quoted for your site or your client portfolio. The ROI calculator works the reader's side of the sum, what routine rounds cost today or what remote patrols would earn, and a quote comes back against it." },
