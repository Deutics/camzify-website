...
const faqs = [
  ...
  { question: 'What does a cloud NVR cost compared with a recorder?', answer: 'Camzify is licensed per camera and quoted for the site; we do not publish rates. A recorder is bought once and then costs disks, replacement and a login per box, so the comparison depends on how many sites and cameras you run. The pricing page explains what a quote is built from.' },
];
