...
const faqs = [
  ...
  { question: 'What does a cloud VMS cost?', answer: 'Cloud VMS products are generally licensed per camera per month rather than sold as hardware. Camzify is quoted per site and does not publish rates. The pricing page explains what a quote is built from, and the ROI calculator compares it against the guarding or recorder costs it replaces.' },
];
