...
const faqs = [
  ...
  { question: 'What does it cost?', answer: 'On Camzify each detection feature is licensed per camera it is enabled on, quoted for the site. Approximate list rates and an estimator are on the pricing page, and quotes come in below list for an annual term. The AI video analytics cost guide explains what the price depends on and how to compare quotes.' },
