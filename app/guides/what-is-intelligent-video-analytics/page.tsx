...
const faqs = [
  ...
  { question: 'What does it cost?', answer: 'On Camzify each detection feature is licensed per camera it is enabled on, quoted for the site. Camzify starts from $5 per camera per month, and a quote for your site comes in lower for an annual term. The AI video analytics cost guide explains what the price depends on and how to compare quotes.' },
