...
The entire round produces a compliance report — exportable as PDF — showing what was checked, when, and the result. This is the audit trail that insurers, regulators, and operations managers need.` }} />
          ...
          <section className="mt-16">
            <ScrollReveal>
              ...
              <div className="mt-4 max-w-prose space-y-4 text-muted-foreground" dangerouslySetInnerHTML={{ __html: `The comparison is not binary — many facilities use both. Virtual patrolling provides the consistent, verifiable baseline; guards provide the physical response capability. The cost difference comes from hours: an overnight post is paid for every hour a person is on it, whether or not anything happens, while a scheduled round on the same cameras is priced per instance and runs as often as the schedule says. Camzify starts from $5 per camera per month; the quote for your site is measured against your own guarding hours. See the full comparison at <a href="/virtual-patrolling/vs-security-guards">virtual patrolling vs security guards</a>, or model your specific scenario with the <a href="/roi-calculator">ROI calculator</a>.` }} />
            </ScrollReveal>
          </section>
