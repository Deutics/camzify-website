  ...
  return (
    <PageShell {...pageMeta} faqs={faqs} breadcrumbs={[
      ...
      <FeatureHero
        ...
        visual={<PhotoFigure src="/partner-hero-for-managed-service-providers.webp" alt="A service provider at a laptop running the Camzify console for a customer" priority />}
      />
