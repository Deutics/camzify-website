...
const pageMeta = {
  ...
  description: "Camzify security notifications: filter by severity, site, camera, feature. Acknowledgement queue with escalation and false positive marking.",
...
const faqs = [
  ...
  { question: 'How does acknowledgement work, and is it logged?', answer: 'Acknowledging an alert marks it as reviewed and records who acknowledged it and when — it\'s not just a checkbox that disappears. Alerts move through four states: Ack Required, Acknowledged, Escalated, and False Positive, so there\'s a clear audit trail of what happened to every event.' },
  ...
  { question: 'Does acknowledging a notification sync with the dashboard\'s critical queue?', answer: 'Yes. Acknowledgement state is shared — acknowledging a critical event from the notifications feed marks it acknowledged in the dashboard\'s critical-event queue too, and vice versa, so the two views never disagree about what\'s still outstanding.' },
];
        ...
        <div className="mx-auto max-w-site px-6">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { icon: CheckCircle2, title: 'Acknowledgement workflow', desc: 'Ack Required, Acknowledged, Escalated, and False Positive states leave a clear audit trail on every alert.' },
