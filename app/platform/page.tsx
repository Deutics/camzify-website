...
const groups = [
  ...
  },
  {
    ...
    modules: [
      { icon: Users, title: 'User management', href: '/platform/user-management', desc: 'Sub-users who can create their own, site-scoped access, quota allocated from your license and requested back.', image: '/security-system-user-management.png' },
      { icon: Lock, title: 'Permission groups', href: '/platform/permission-groups', desc: 'Page-level access combined with create, read, update and delete rights per resource, one group per user.', image: '/permission-group.png' },
      { icon: Layers, title: 'License & instances', href: '/platform/license-and-instance-management', desc: 'What is activated, what is granted to sub-accounts and what remains available, per feature.', image: '/license-and-instance-management.png' },
      { icon: Globe, title: 'Multi-site management', href: '/platform/multi-site-management', desc: 'Every site set up independently and read from one console, folded together or held separate.', image: '/multi-site-video-surveillance.png' },
    ],
  },
];
            ...
            <ScrollReveal>
              <div>
                ...
                <p className="mt-5 max-w-prose text-body text-muted-foreground">
                  ...
                  is described on <Link href="/cloud-video-surveillance" className="text-primary hover:underline">cloud video surveillance</Link>. How it differs from a recorder-based system is on <Link href="/compare/camzify-vs-traditional-vms" className="text-primary hover:underline">Camzify vs traditional VMS</Link>. If the term is new, <Link href="/guides/what-is-a-cloud-vms" className="text-primary hover:underline">what a cloud VMS is</Link> and <Link href="/guides/cloud-vms-cost" className="text-primary hover:underline">what drives its cost</Link> are the two guides to read first, and the <Link href="/compare" className="text-primary hover:underline">comparisons</Link> set Camzify against Verkada, Rhombus, Solink, Spot AI, Coram AI, Avigilon Alta and Eagle Eye Networks.
                </p>
              </div>
            </ScrollReveal>
