...
const faqs = [
  ...
  { question: 'Where is the footage stored?', answer: 'Footage is written to cloud object storage (Amazon S3) in the AWS region nearest the customer\'s sites, encrypted at rest, so retrieval stays fast and data stays close to where it was recorded. Retention decides how long it stays: a window in days or a storage cap per camera, and when footage ages out it is deleted from that storage.' },
