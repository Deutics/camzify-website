...
const faqs = [
  { question: 'Why does the calculator not show what Camzify costs?', answer: 'Because the quote is set for your site and comes in lower for an annual term or more features per camera, so any figure here would be wrong for most readers. What we can say is that Camzify starts from $5 per camera per month. The honest calculation is the half that is yours: what routine rounds cost you today, or what remote patrols would earn you at the rate you set. Build your configuration on the pricing page and the quote comes back against that figure.' },
