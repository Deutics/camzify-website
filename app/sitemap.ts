...
const useCases = group(
  [
    ...
    '/use-cases/fall-detection-for-hospitals-and-care-homes',
    '/use-cases/weapons-detection-for-schools-and-public-buildings',
    '/use-cases/violence-detection-in-emergency-departments',
    '/use-cases/fire-and-smoke-detection-for-high-rise-buildings',
    '/use-cases/fire-exit-and-escape-route-monitoring',
    '/use-cases/occupancy-limits-for-venues-and-public-spaces',
    '/use-cases/tracking-one-person-across-cameras',
    '/use-cases/virtual-patrolling-for-compliance-evidence',
    '/use-cases/tailgating-detection-for-data-centers-and-secure-entrances',
    '/use-cases/car-theft-and-vandalism-in-parking-facilities',
    '/use-cases/fire-lane-and-emergency-access-enforcement',
    '/use-cases/cloud-video-backup-against-dvr-theft',
    '/use-cases/one-live-wall-for-every-brand-and-location',
