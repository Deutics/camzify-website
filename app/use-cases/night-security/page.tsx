...
const faqs = [
  ...
  { question: 'Can the AI tell a night cleaner from an intruder?', answer: 'By place and time, not identity. Each detection has a notification window per camera, so a cleaning crew scheduled until 22:00 does not notify on a window that starts at 22:30. Attribute extraction can describe who was seen, clothing and what they carried, for the person who attends. It does not recognize faces.' },
...
const content: UseCaseContent = {
  ...
  image: { src: '/night-security.png', alt: 'Facility perimeter at night with networked security cameras around the building' },
  ...
  handles: {
    ...
    detections: [
      { href: '/ai-features/zone-intrusion-detection', name: 'Zone intrusion detection', role: 'Yards, corridors and rooms with an overnight notification window. A tracked person during it is the event.' },
      ...
      { href: '/ai-features/fire-and-smoke-detection', name: 'Fire and smoke detection', role: 'Flame and smoke signatures on any camera, the other overnight risk an empty site carries. See fire and smoke monitoring.' },
    ],
  },
  round: {
