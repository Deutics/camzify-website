...
const groups = [
  {
    ...
    items: [
      { title: 'Perimeter security', href: '/use-cases/perimeter-security', icon: Shield, desc: 'Fence lines, gates and open ground, checked every round and watched between rounds.', image: '/ai-perimeter-security.png' },
      ...
      { title: 'Unauthorized access detection', href: '/use-cases/unauthorized-access-detection', icon: KeyRound, desc: 'Zones notified in the hours you set, and the tailgating a badge reader never sees.', image: '/unauthorized-access-detection.png' },
      ...
      { title: 'Night security', href: '/use-cases/night-security', icon: MoonStar, desc: 'Overnight rounds that run on the fourth night as reliably as the first.', image: '/night-security.png' },
    ],
  },
  {
    eyebrow: '02',
    ...
    items: [
      ...
      { title: 'Loading dock monitoring', href: '/use-cases/loading-dock-monitoring', icon: Truck, desc: 'Door status, staging areas and vehicles at the bay, checked against the delivery window.', image: '/loading-dock-security.png' },
      ...
      { title: 'Parking lot surveillance', href: '/use-cases/parking-lot-surveillance', icon: ParkingCircle, desc: 'People after hours, fire lanes, restricted bays and vehicles left where they should not be.', image: '/parking-lot-surveillance.png' },
      { title: 'Vehicle monitoring', href: '/use-cases/vehicle-monitoring', icon: Car, desc: 'Vehicles tracked as objects at gates, yards and bays. Not plate reading.', image: '/vehicle-monitoring.png' },
    ],
  },
  {
    eyebrow: '03',
    ...
    items: [
      { title: 'Guard tour verification', href: '/use-cases/guard-tour-verification', icon: ClipboardCheck, desc: 'Proof of the condition at each checkpoint, not proof that a tag was tapped.', image: '/guard-tour-verification.png' },
      { title: 'Remote site monitoring', href: '/use-cases/remote-site-monitoring', icon: Radio, desc: 'Unmanned sites on the same rounds and the same console as staffed ones.', image: '/remote-site-monitoring.png' },
      { title: 'Remote video monitoring', href: '/use-cases/remote-video-monitoring', icon: Video, desc: 'A site watched from a monitoring room: rounds on schedule, detections in the window set, a report per client.', image: '/remote-site-monitoring.png' },
      ...
      { title: 'Lock-up and closing checks', href: '/use-cases/lock-up-and-closing-checks', icon: DoorClosed, desc: 'A closing round that checks doors, shutters and lights from the camera, with a frame per item.', image: '/after-hours-security-monitoring.png' },
      { title: 'Alarm verification', href: '/use-cases/alarm-verification', icon: BellRing, desc: 'The camera view and a snapshot on the operator\'s desk at the moment the alarm comes in.', image: '/unauthorized-access-detection.png' },
      { title: 'Camera health monitoring', href: '/use-cases/camera-health-monitoring', icon: Video, desc: 'Tampering raised as it happens, offline shown as offline, camera view checked on every round.', image: '/remote-site-monitoring.png' },
    ],
  },
  {
    eyebrow: '04',
    ...
    items: [
      { title: 'Fire and smoke monitoring', href: '/use-cases/fire-and-smoke-monitoring', icon: Flame, desc: 'Visual flame and smoke as an early-warning layer, and fire exits checked on the round.', image: '/ai-perimeter-security.png' },
      { title: 'Workplace safety monitoring', href: '/use-cases/workplace-safety-monitoring', icon: HeartPulse, desc: 'Falls raised live, exits and exclusion zones on the checklist, the site recorded at each time.', image: '/loading-dock-security.png' },
      { title: 'PPE compliance monitoring', href: '/use-cases/ppe-compliance-monitoring', icon: HardHat, desc: 'Hats, vests and gloves checked per person against the policy for each zone.', image: '/vehicle-monitoring.png' },
      { title: 'Violence and weapons detection', href: '/use-cases/violence-and-weapons-detection', icon: ShieldAlert, desc: 'A visible weapon or an altercation raised as critical with a clip, verified by a person.', image: '/unauthorized-access-detection.png' },
      { title: 'Occupancy monitoring', href: '/use-cases/occupancy-monitoring', icon: Users, desc: 'Live counts and peak hours per zone from the tracking that already runs. No counting hardware.', image: '/parking-lot-surveillance.png' },
    ],
  },
];
