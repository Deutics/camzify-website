...
const faqs = [
  { question: 'Does it detect shoplifting?', answer: 'It does not detect the act of concealing merchandise, and we will not claim it does. What it detects is presence and movement against a rule: a person in the stockroom in the hours it should be empty, a person in the cage who did not come through the door, an object left where it should not be. For a retail floor that is awareness, not a shoplifting alarm.' },
  { question: 'How does it help with internal theft?', answer: 'Each camera carries a notification window. The cash office, the stockroom and the high-value cage can each be a zone, notified in the hours the area should be empty, and entry during them raises an alert with the snapshot. A patrol round checks those areas are clear on schedule and records it, which is a deterrent in itself once staff know the round exists and is recorded.' },
