...
const faqs = [
  ...
  { question: 'What about vehicles being damaged in a car park?', answer: 'Zone rules with after-hours schedules cover the car park, and a person moving between parked vehicles at night is the event. Vehicle damage report, one of the 23 detections, assesses visible damage on a vehicle in frame; it is built for fleet and rental inspection rather than as an alarm.' },
