...
const faqs = [
  ...
  { question: 'How is a virtual guard priced?', answer: 'Camzify is priced per instance per month, a stream instance for each camera plus a detection instance for each AI feature on it, and quoted for the site; we do not publish rates. The quote is measured against the guarding hours it replaces, which the ROI calculator lets you work out with your own figures before you talk to anyone.' },
];
