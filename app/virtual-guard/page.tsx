...
const faqs = [
  ...
  { question: 'How is a virtual guard priced?', answer: 'Camzify is priced per instance per month, a stream instance for each camera plus a detection instance for each AI feature on it, and quoted for the site; approximate list rates and an estimator are on the pricing page, and quotes come in below list for an annual term. The quote is measured against the guarding hours it replaces, which the ROI calculator lets you work out with your own figures before you talk to anyone.' },
];
        ...
        <div className="mx-auto max-w-site px-6">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <ScrollReveal delay={0.1}>
              ...
              <p className="mt-4 max-w-prose text-body text-muted-foreground">
                If you are that agency or monitoring company, this is the offer you can put on the cameras your clients already have, priced per instance per month rather than per hour. The <Link href="/partners/for-security-agencies" className="text-primary hover:underline">security agencies</Link> and <Link href="/partners/for-monitoring-centers" className="text-primary hover:underline">monitoring companies</Link> pages cover the account model, and the <Link href="/guides/how-to-sell-virtual-patrolling-to-clients" className="text-primary hover:underline">selling guide</Link> covers the pitch. Sites that want to run it themselves can; the console does not care who is logged in.
              </p>
            </ScrollReveal>
          </div>
        </div>
