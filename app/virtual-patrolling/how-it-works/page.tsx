  ...
  return (
    ...
    >
      <FeatureHero
        ...
        visual={<HeroPlaceholder label="Perimeter round · 4 stops" alt="A four-camera patrol sequence with the main gate as the current stop" />}
      />
