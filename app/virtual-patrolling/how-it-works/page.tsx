...
const faqs = [
  ...
  { question: 'What is the difference between a manual round and an automated one?', answer: 'A manual round is walked by an operator, camera by camera, making each judgement against the live view. An automated round follows the same sequence on a schedule with the AI making the assessment, recording its reasoning, notifying guards on its own and filing the report without anyone present. Most sites use automated rounds for frequency and manual rounds when a person needs to look properly.' },
];
