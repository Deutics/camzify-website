...
const steps = [
  { icon: Wifi, title: '1. Connect your cameras', desc: 'Any IP camera connects over one of three connection types: RTSP, RTMP or HTTPS. The Camzify Connector handles local network cameras. Stream quality is auto-detected on connect — no manual configuration needed.', image: '/how-it-works-Step-1.jpg', imageAlt: 'A person connecting a physical camera while the Camzify Configuration screen adds it over the network on a laptop' },
